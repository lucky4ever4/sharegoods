...
public class RatingService {
    ...
    /*
            In case of performed validation

     public boolean validationRating(int rating) throws RatingException {
    ...
    public Rating createRating(Long userId, Long itemId, Double rating) throws UserNotFoundException, ItemNotFoundException, RatingException {
